...
/// <summary>
/// Merchant-to-merchant negotiation lifecycle. A negotiation is an offer/counter-offer
...
public enum B2BNegotiationStatus
{
    ...
    /// <summary>
    /// Both merchants agreed on the current offer revision. This is where the
